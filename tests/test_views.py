    ...
    def test_index_view_post_valid_image(self):
        with tempfile.NamedTemporaryFile(suffix=".jpg") as tmp_file:
            ...
            image = SimpleUploadedFile(
                tmp_file.name, tmp_file.read(), content_type="image/jpeg"
            )
    ...
    def test_index_view_post_invalid_file(self):
        with tempfile.NamedTemporaryFile(suffix=".txt") as tmp_file:
            ...
            text_file = SimpleUploadedFile(
                tmp_file.name, tmp_file.read(), content_type="text/plain"
            )
            ...
            self.assertEqual(
                context["message"],
                "Not a supported file type. Choose a different image.",
            )
